...
python -m torch.distributed.launch --nnodes=1 --master_port 12345 --nproc_per_node=1  train.py --name mm --stage test --model vit_base_patch16 --model_type ViT-B_16 --num_classes 14 \
