...
python -m torch.distributed.launch --nnodes=1 --master_port 12345 --nproc_per_node=2  train.py --name mm --stage train --model vit_base_patch16 --model_type ViT-B_16 --num_classes 14 \
